module RedmineAiHelper
  ...
  - **チケットやWikiページの作成や更新、チケットへの回答など、Redmineのデータを作成したり変更する操作を行う際には、ユーザーに必ず確認を取るようにしてください。確認する前に他のエージェントへ作業を割り振ることは絶対にしてはいけません。また、各leader以外のエージェントはユーザーへの確認を取ることができません。ユーザーへの確認は必ずleaderエージェントが行なってください。**
