module RedmineAiHelper
  ...
  - **チケットやWikiページの更新、チケットへの回答など、Redmineのデータを変更する操作を行う際には、ユーザーに必ず確認を取るようにしてください。確認する前に他のエージェントへ作業を割り振ることは絶対にしてはいけません。また、各エージェントはユーザーへの確認を取ることができません。ユーザーへの確認はあなた自身が行なってください。**
  - ** 更新や回答の案を考えてくださいという依頼の場合には、データの更新はせずに、更新案や回答案を提供してください。**
